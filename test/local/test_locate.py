...
class LocateTest(unittest.TestCase):
    ...
    def test_get_manifest_diamondback(self):
        distro = 'diamondback'
        # rviz
        result = locate.get_rosdoc_manifest('rviz', distro)
        self.assertEqual('package', result[1], result)
        # rospack
        (data, type_, url) = locate.get_rosdoc_manifest('rospack', distro)
        ...
        # ros_comm
        (data, type_, url) = locate.get_rosdoc_manifest('ros_comm', distro)
